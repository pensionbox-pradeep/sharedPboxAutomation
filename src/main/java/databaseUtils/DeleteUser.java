...
public class DeleteUser {
	...
	public void deleteUser(String phNo) throws SQLException{
		try(Connection con = DriverManager.getConnection("jdbc:mysql://pensionbox-qa-database.clvkkb0owtsr.ap-south-1.rds.amazonaws.com/pensionbox_qa?useSSL=false&allowPublicKeyRetrieval=true", "admin", "qa12345678");
